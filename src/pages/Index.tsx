      ...
      <section className="py-12 bg-gradient-to-r from-secondary to-secondary/80">
        <div className="container text-center">
          <div className="max-w-2xl mx-auto">
            ...
            <Link to="/auth" className="inline-flex items-center gap-2 bg-accent text-accent-foreground font-bold px-8 py-4 rounded-xl text-lg hover:bg-accent/90 transition-colors shadow-lg hover:shadow-xl">
